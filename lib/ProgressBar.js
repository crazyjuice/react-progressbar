...
var ProgressBar = exports.ProgressBar = function ProgressBar(props) {
  ...
  var customClass = (_customClass = {}, _defineProperty(_customClass, position, 0), _defineProperty(_customClass, 'width', progress + '%'), _defineProperty(_customClass, 'height', lineHeight + 'px'), _defineProperty(_customClass, 'background', lineColor), _defineProperty(_customClass, 'boxShadow', '0 0 10px ' + lineColor), _defineProperty(_customClass, 'opacity', progress === (0 || 100) ? 0 : 1), _defineProperty(_customClass, 'zIndex', zIndex), _customClass);
